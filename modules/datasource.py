...
class DataSource(Protocol):
    ...
    def get_daily_by_trade_date(self, trade_date: str) -> pd.DataFrame | None: ...
...
class TushareDataSource:
    ...
    def get_daily_by_trade_date(self, trade_date: str) -> pd.DataFrame | None:
        return self._client.get_daily_by_trade_date(trade_date)
...
class CompositeDataSource:
    ...
    def get_daily_by_trade_date(self, trade_date: str) -> pd.DataFrame | None:
        if self._preferred == "tushare":
            return self._tushare_source.get_daily_by_trade_date(trade_date)
        if self._preferred in ("auto", "sqlite"):
            return self._sqlite.get_daily_by_trade_date(trade_date)
        return None
