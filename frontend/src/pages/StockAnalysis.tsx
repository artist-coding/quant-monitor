...
export default function StockAnalysis() {
  ...
  return (
    <div className="space-y-5 animate-fade-up">
      {/* ============ Header - 股票信息 ============ */}
      <div className="relative overflow-hidden rounded-2xl border border-border/60 bg-gradient-to-br from-bg-secondary via-bg-card to-bg-secondary shadow-xl shadow-black/20">
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top_right,rgba(79,142,247,0.10),transparent_55%)]"></div>
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_bottom_left,rgba(157,107,245,0.08),transparent_55%)]"></div>
        <div className="absolute inset-x-0 top-0 h-px bg-gradient-to-r from-transparent via-accent-gold/40 to-transparent"></div>
          ...
          <div className="flex items-start justify-between gap-6 flex-wrap">
            <div className="min-w-0">
              <div className="flex items-center gap-3 mb-3 flex-wrap">
                ...
                <span className="text-sm text-accent-gold bg-accent-gold/10 px-3 py-1 rounded-full ring-1 ring-inset ring-accent-gold/25 font-medium">
                  {analysis.name}
                </span>
              </div>
              <div className="text-xs text-text-muted flex items-center gap-2">
                <span className="inline-block w-1.5 h-1.5 rounded-full bg-accent-green animate-soft-pulse"></span>
          ...
          {(analysis.waves || analysis.kirin) && (
            <Card title="主力阶段">
              <div className="space-y-3">
                {analysis.waves && (
                  <div className="flex items-center justify-between p-3.5 rounded-xl bg-gradient-to-r from-accent-blue/[0.10] to-accent-purple/[0.10] ring-1 ring-inset ring-accent-blue/20">
                    <div>
                ...
                {analysis.kirin && (
                  <div className="flex items-center justify-between p-3.5 rounded-xl bg-gradient-to-r from-accent-gold/[0.10] to-accent-orange/[0.10] ring-1 ring-inset ring-accent-gold/20">
                    <div>
