...
def test_sqlite_datasource_get_daily_by_trade_date(temp_db, db_conn):
    ...
    result = SqliteDataSource().get_daily_by_trade_date("20260115")
    assert result is not None
    assert result["ts_code"].tolist() == ["600519.SH"]
